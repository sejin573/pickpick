...
- **테스트 계정:** 게스트 추천은 계정 없이 사용 가능 / 대화 저장은 이메일 Magic Link 로그인 사용
- **현재 버전:** v1.7.0
...
| 테스트 계정 | 게스트 추천은 별도 계정 없이 사용할 수 있으며, 대화 저장 기능은 사용자의 이메일 Magic Link 로그인을 사용합니다. |
...
[▶ PickPick v1.6.0 시연 영상 보기](docs/videos/pickpick-demo-v160.mp4)
...
- 로그인 기능은 Supabase 이메일 Magic Link 방식으로 제공
